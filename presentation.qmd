---
title: "Volleyball Stats Shiny Dashboard"
subtitle: "Project 2"
author: "Willow White"
...
-   Goal:
    -   Create a shiny dashboard for visualizing volleyball statistics
    -   Tool for coaches and players
-   My dataset:
    -   NCAA (National Collegiate Athletic Association) Women's Volleyball Stats 2012 - 2019
    -   781,962 observations, 26 variables --\> 781,962 observations, 17 variables
    -   Each row player + game
    -   All players participated

## App 1

-   Table displaying different stats

    -   Change player or team
    -   Slider to filter for year
    -   Average or all stats

-   Rachel Todorovich, all stats, 2012

    -   Helpful for looking at particular games
...
-   Rachel Todorovich, average stats, 2012

    -   Helpful for looking at overall trends
...
-   WSU, average stats, 2012

    -   Helpful for comparing players
...
-   Volleyball popularity map
-   Most popular/most teams in Texas and California
...
-   Volleyball stats bar graph
    -   Select player or team
    -   Selct statistics of interest
    -   Change year
